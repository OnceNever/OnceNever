...
![image-20230922223517480](https://blog.seeyourface.cn/blog/image-20230922223517480.png)

我们很容易能联想到可以用MySQL实现。

假设我们的建表SQL是这样的:

![image-20230922224514427](https://blog.seeyourface.cn/blog/image-20230922224514427.png)
...
![image-20230922224640869](https://blog.seeyourface.cn/blog/image-20230922224640869.png)
...
![image-20230922225317030](https://blog.seeyourface.cn/blog/image-20230922225317030.png)
...
![image-20230922225605773](https://blog.seeyourface.cn/blog/image-20230922225605773.png)

主键索引本质是一棵B+树，它是放在innodb中的一个数据结构。

我们可以回忆下，B+树大概长这样。

![image-20230922225637429](https://blog.seeyourface.cn/blog/image-20230922225637429.png)
...
![image-20230922230006225](https://blog.seeyourface.cn/blog/image-20230922230006225.png)
...
上面select后面带的是**星号**，也就是要求获得行数据的所有字段信息。
...
![image-20230922231012627](https://blog.seeyourface.cn/blog/image-20230922231012627.png)
...
我们可以将所有的数据**根据id主键进行排序**，然后分批次取，将**当前批次的最大id作为下次筛选的条件**进行查询。

可以看下伪代码：

![image-20230922231706442](https://blog.seeyourface.cn/blog/image-20230922231706442.png)

这个操作，可以通过主键索引，每次定位到id在哪，然后往后遍历100个数据，这样不管是多少万的数据，查询性能都很稳定。

![image-20230922231821926](https://blog.seeyourface.cn/blog/image-20230922231821926.png)
...
![image-20230922231926176](https://blog.seeyourface.cn/blog/image-20230922231926176.png)
...
![image-20230922232056893](https://blog.seeyourface.cn/blog/image-20230922232056893.png)
