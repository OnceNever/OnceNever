...
![image-20231113102320148](https://image.seeyourface.cn/migrate/image-20231113102320148.png)

果然，不出我们所料。它有一个默认的实现类从 `yml` 配置文件中读取数据源连接。

![image-20231113102557770](https://image.seeyourface.cn/migrate/image-20231113102557770.png)
...
![image-20231113104316481](https://image.seeyourface.cn/migrate/image-20231113104316481.png)
...
![image-20231113110534993](https://image.seeyourface.cn/migrate/image-20231113110534993.png)
